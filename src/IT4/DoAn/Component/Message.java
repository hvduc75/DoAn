...
public class Message extends javax.swing.JPanel {
    ...
    public void showMessage(MessageType messageType, String message) {
        ...
        if (messageType == MessageType.SUCCESS) {
            lbMessage.setIcon(new ImageIcon(getClass().getResource("/IT4/DoAn/icon/success.png")));
        } else {
            lbMessage.setIcon(new ImageIcon(getClass().getResource("/IT4/DoAn/icon/error.png")));
        }
    }
