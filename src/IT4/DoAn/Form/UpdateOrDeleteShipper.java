...
public class UpdateOrDeleteShipper extends javax.swing.JFrame {
    ...
    public UpdateOrDeleteShipper(Shipper shipper, Main testInstance) {
        ...
        initComponents();
        NameTextField.setText(shipper.getName());
        String[] bDay = shipper.getBirthDay().split("-");
        Ngay1.setValue(Integer.valueOf(bDay[0]));
        Thang1.setValue(Integer.valueOf(bDay[1]));
        Nam1.setValue(Integer.valueOf(bDay[2]));
        if (shipper.getGender().equals("Male")) {
        ...
        String[] sDay = shipper.getStartWork().split("-");
        Ngay2.setValue(Integer.valueOf(sDay[0]));
        Thang2.setValue(Integer.valueOf(sDay[1]));
        Nam2.setValue(Integer.valueOf(sDay[2]));
        Phone.setText(shipper.getPhone());
        Email.setText(shipper.getEmail());
        Address.setText(shipper.getAddress());
        Description.setText(shipper.getDescription());
    }
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(30, 30, 30))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jlbMSG, javax.swing.GroupLayout.PREFERRED_SIZE, 422, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void btnUpdateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnUpdateMouseClicked
        if (isLegal) {
            ...
            shipper.setShipper_Id(this.shipper.getShipper_Id());
            ...
            if (NameTextField.getText().isEmpty() || Phone.getText().isEmpty()
                ...
                if (selectedDate.isAfter(currentDate) || selectedDate1.isAfter(currentDate)) {
                    if (selectedDate.isAfter(currentDate)) {
                        ...
                        String birthDay1 = "";
                        birthDay1 += Ngay1.getValue() + "-" + Thang1.getValue() + "-" + Nam1.getValue();
                        shipper.setBirthDay(birthDay1);
                    }
                    if (selectedDate1.isAfter(currentDate)) {
                        ...
                        String startWork1 = "";
                        startWork1 += Ngay2.getValue() + "-" + Thang2.getValue() + "-" + Nam2.getValue();
                        shipper.setStartWork(startWork1);
                    }
                } else {
    ...
    private void btnDeleteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDeleteMouseClicked
        int shipperId = this.shipper.getShipper_Id();
        int number = searchService.NOOBDelivered(shipperId);
        if (number > 0) {
            int confirm = JOptionPane.showConfirmDialog(this, "Shipper này đang giao hàng nếu bạn xóa Shipper các đơn hàng sẽ được chuyển về kho");
            if (confirm == JOptionPane.YES_OPTION) {
                shipperservice.UpdateOrdersOfShipper(shipperId);
                shipperservice.UpdateDelete(shipperId);
            }
        } else {
            int confirm = JOptionPane.showConfirmDialog(this, "Bạn có chắc chắn muốn xóa Shipper này không !");
            if (confirm == JOptionPane.YES_OPTION) {
                shipperservice.UpdateDelete(shipperId);
            }
        }
