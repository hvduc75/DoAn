...
import IT4.DoAn.Component.Message;
import IT4.DoAn.Component.PanelCover;
import IT4.DoAn.Component.PanelLoading;
import IT4.DoAn.Component.PanelLoginAndRegister;
import IT4.DoAn.Component.PanelVerifyCode;
import IT4.DoAn.Controller.ConnectionToSQLServer;
import IT4.DoAn.Main.Main;
import IT4.DoAn.Model.ModelLogin;
import IT4.DoAn.Model.ModelMessage;
import IT4.DoAn.Model.ModelUser;
import IT4.DoAn.Service.ServiceMail;
import IT4.DoAn.Service.ServiceUser;
...
public class Login extends javax.swing.JFrame {
    ...
    private void register() {
        ...
        try {
            ...
            } else if (!service.checkConfirmPassword(user.getPassword(), user.getConfirmPassword())) {
                showMessage(Message.MessageType.ERROR, "Confirm Password is not exactly");
            } else {
    ...
    public static void main(String args[]) {
        try {
            ConnectionToSQLServer db = new ConnectionToSQLServer();
            db.getJDBCConnectionAccount();
        } catch (Exception e) {
            e.printStackTrace();
        }
